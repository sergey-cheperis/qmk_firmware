...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, _______, RGB_VAI, _______, RGB_HUI, RGB_SAI, _______, U_T_AUTO,U_T_AGCR,_______, KC_PSCR, KC_SLCK, KC_PAUS, _______, _______, \
        _______, _______, RGB_VAD, _______, RGB_HUD, RGB_SAD, _______, _______, _______, _______, _______, _______,          _______, KC_VOLU, \
...
void matrix_init_user(void) {
    ...
    rgb_matrix_sethsv_noeeprom(40, 255, 96);
...
void rgb_matrix_indicators_user(void) {
    ...
    if (host_keyboard_leds() & (1 << USB_LED_CAPS_LOCK)) {
        if (HAS_FLAGS(rgb_matrix_get_flags(), LED_FLAG_KEYLIGHT)) {
            rgb = hsv_to_rgb((HSV){ .h = 8, .s = 255, .v = rgb_matrix_get_val() });
        } else {
